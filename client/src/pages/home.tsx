        ...
        <div className="bg-gray-800 border-t border-gray-700 py-4 px-3 flex flex-col space-y-3">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex flex-1 items-center space-x-2">
              <label className="text-xs text-gray-400 w-12 flex-shrink-0">위도</label>
              <input
            ...
            <div className="flex flex-1 items-center space-x-2">
              <label className="text-xs text-gray-400 w-12 flex-shrink-0">경도</label>
              <input
                className="text-sm font-mono bg-gray-700 px-3 py-2 rounded-md text-gray-100 flex-1"
          ...
          {/* 지번주소 + 복사 버튼 한 줄로(이미지 스타일) */}
          <div className="flex items-center space-x-0">
            <label className="text-xs text-gray-400 w-16 flex-shrink-0">지번주소</label>
            <input
              className="text-sm bg-gray-700 px-3 py-2 rounded-l-md text-gray-100 flex-1 border-none"
            ...
            <button
              ...
              className="flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white font-medium px-5 py-2 rounded-r-md transition-colors duration-200 h-[40px] w-[80px] disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
          ...
          <div className="flex items-start space-x-3">
            <label className="text-xs text-gray-400 w-16 flex-shrink-0 pt-2">세부내역</label>
            <textarea
              maxLength={100}
              rows={2}
              className="text-sm bg-gray-700 px-3 py-2 rounded-md text-gray-100 flex-1 resize-none"
              value={detail}
              onChange={e => setDetail(e.target.value)}
              placeholder="최대 100자 입력 (2줄까지)"
              style={{ minHeight: "2.8em", maxHeight: "4em" }}
            />
          </div>
